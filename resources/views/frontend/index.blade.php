                ...
                <div class="col-md-3">
                    ...
                    <div class="list-group ttk-dwdbar">
                        ...
                        <div class="qrcode clearfix">
                            @if (Agent::isMobile())
                                <div>
                                    <img src="https://taythien.garena.vn/frontend/images/img-qrcode.png" alt="">
                                    <p><span>Quét mã QR </span>để tải game và chơi trên điện thoại di động</p>
                                </div>
                                <div class="ol-mb">
                                    <h3>{{$trailer->title}}</h3>

                                    <div class="videopopup clearfix">
                ...
                <div class="col-md-9">
                    <div class="tab-ttsk">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#huongdan" aria-controls="huongdan" role="tab" data-toggle="tab">Hướng dẫn</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="huongdan">
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        @if ($firstNewsPost = array_shift($indexNewsGuide))
                                            <div class="thumbnail">
                                                <a href="{{url($firstNewsPost->slug.'.html')}}"><img src="{{url('img/cache/555x401', $firstNewsPost->image)}}" alt="{{$firstNewsPost->title}}"></a>
                                                <div class="caption">
                                                    <h3><a href="{{url($firstNewsPost->slug.'.html')}}">{{$firstNewsPost->title}}</a></h3>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        @foreach ($indexNewsGuide as $post)
                                            <div class="thumbnail">
                                                <a href="{{$post->slug.'.html'}}"><img src="{{url('img/cache/262x190', $post->image)}}" alt="{{$post->title}}"></a>
                                                <div class="caption">
                                                    <h3><a href="{{$post->slug.'.html'}}">{{$post->title}}</a></h3>
